	...
	static vector<wstring> Enumerate()
	{
		...
		for (int n = 0; n < nDeviceCount; n++)
			if (waveOutGetDevCaps(n, &woc, sizeof(WAVEOUTCAPS)) == S_OK)
				sDevices.emplace_back(woc.szPname);
...
private:
	...
	void MainThread()
	{
		...
		auto dMaxSample = (double)nMaxSample;
...
//template<class T>
//OldNoiseMaker<T>::OldNoiseMaker(wstring sOutputDevice, unsigned int nSampleRate /*= 44100*/, unsigned int nChannels /*= 1*/, unsigned int nBlocks /*= 8*/, unsigned int nBlockSamples /*= 512*/)
//{
//	Create(sOutputDevice, nSampleRate, nChannels, nBlocks, nBlockSamples);
//}
//
//template<class T>
//OldNoiseMaker<T>::~OldNoiseMaker()
//{
//	Stop();
//	Destroy();
//}
//
//template<class T>
//bool OldNoiseMaker<T>::Create(wstring sOutputDevice, unsigned int nSampleRate /*= 44100*/, unsigned int nChannels /*= 1*/, unsigned int nBlocks /*= 8*/, unsigned int nBlockSamples /*= 512*/)
//{
//	m_bReady = false;
//	m_nSampleRate = nSampleRate;
//	m_nChannels = nChannels;
...
//	m_bReady = true;
//
//	m_thread = thread(&OldNoiseMaker::MainThread, this);
//
//	return true;
//}
//
//template<class T>
//bool OldNoiseMaker<T>::Destroy()
//{
//	return false;
//}
//
//template<class T>
//void OldNoiseMaker<T>::Stop()
//{
//	m_bReady = false;
//	m_thread.join();
//}
//
//template<class T>
//double OldNoiseMaker<T>::UserProcess(double dTime)
//{
//	return 0.0;
//}
//
//template<class T>
//void OldNoiseMaker<T>::SetUserFunction(double(*func)(double))
//{
//	m_userFunction = func;
//}
//
//
//template<class T>
//double OldNoiseMaker<T>::clip(double dSample, double dMax)
//{
//	if (dSample >= 0.0)
//		return fmin(dSample, dMax);
//
...
//
//template<class T>
//void OldNoiseMaker<T>::waveOutProc(HWAVEOUT hWaveOut, UINT uMsg, DWORD dwParam1, DWORD dwParam2)
//{
//	if (uMsg != WOM_DONE) return;
//
//	m_nBlockFree++;
...
//
//template<class T>
//void CALLBACK OldNoiseMaker<T>::waveOutProcWrap(HWAVEOUT hWaveOut, UINT uMsg, DWORD dwInstance, DWORD dwParam1, DWORD dwParam2)
//{
//	((OldNoiseMaker*)dwInstance)->waveOutProc(hWaveOut, uMsg, dwParam1, dwParam2);
//}
//
//template<class T>
//void OldNoiseMaker<T>::MainThread()
//{
//	m_dGlobalTime = 0.0;
//	double dTimeStep = 1.0 / (double)m_nSampleRate;
//
